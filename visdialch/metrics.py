...
def scores_to_ranks(scores: torch.Tensor):
    ...
    _, real_rank = torch.sort(ranked_idx)
    ...
    '''
    ranks = (real_rank + 1).view(batch_size, num_rounds, -1)
    return ranks
...
class NDCG(object):
    ...
    def observe(
        ...
        """
        batch_size, num_options = predicted_scores.size()
        predicted_scores = predicted_scores.detach()
        ...
        predicted_ranks = predicted_ranks.view(batch_size, num_options)
